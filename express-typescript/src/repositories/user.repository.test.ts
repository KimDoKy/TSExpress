...
import { generateUserData, generateUserPayload, generateUsersData } from "../../test/utils/generate";
...
describe("UserRepository", () => {
    describe("getUsers", () => {
        ...
        test("should return user list", async () => {
            const usersData = generateUserData(2);
    ...
    describe("addUser", () => {
        describe("should add user to the database", async () => {
